    ...
    public class SchoolContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder){
            ...
            var Grades = new Grade[] {
                ...
                new Grade { Id = 1, StudentId = 2, CourseName = "Track 302", Value = 45.00F },
                new Grade { Id = 1, StudentId = 3, CourseName = "Track 302", Value = 87.25F },
                new Grade { Id = 2, StudentId = 1, CourseName = "Martial Arts 302", Value = 100.00F },
                new Grade { Id = 2, StudentId = 2, CourseName = "Martial Arts 302", Value = 98.99F },
                new Grade { Id = 3, StudentId = 4, CourseName = "Calculus 302", Value = 76.50F },
                new Grade { Id = 3, StudentId = 5, CourseName = "Calculus 302", Value = 88.00F }
            };
